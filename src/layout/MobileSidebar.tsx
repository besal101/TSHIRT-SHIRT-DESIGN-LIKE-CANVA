...
const MobileSideBar: React.FC<IMobileSideBarProps> = (props) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-800 opacity-60 w-full h-full absolute"
                ...
                <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    <div className="w-6 h-6 md:w-8 md:h-8">
                      <GoDashboard size={20} color="#FFF" />
                    </div>
                    <span className="xl:text-base md:text-2xl text-base ml-1 font-manrope">
                      Dashboard
                    </span>
                  </div>
                </li>
